...
diff --git a//dev/null b/calc_silo_vertical.py
index 0000000000000000000000000000000000000000..8041a0260a0e29711f348dbf28234bb4185985db 100644
--- a//dev/null
+++ b/calc_silo_vertical.py
@@ -0,0 +1,90 @@
+import math
